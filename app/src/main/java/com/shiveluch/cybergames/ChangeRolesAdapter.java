...
public class ChangeRolesAdapter extends BaseAdapter {
    Context ctx;
    LayoutInflater lInflater;
    ArrayList<Roles> objects;

    protected ListView mListView;
    public ChangeRolesAdapter(Context context, ArrayList<Roles> stalkers, Activity activity) {
        super();
        ctx = context;
        objects = stalkers;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = lInflater.inflate(R.layout.rolesdialog, parent, false);
        }
